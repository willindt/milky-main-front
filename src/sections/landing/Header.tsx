  ...
  return (
    <>
      <div className={style.planets}>
        <img className={style.planets} style={{ top: '9%', left: '60%' }} src={planet2} />
      </div>
      ...
      <div className={style.article}>
        ...
        <div className={style.btn__groups}>
          <a href="/swap"><button className={style.btn1}>Enter App</button></a>
          <a href="https://docs.milkyway.exchange/"><button className={style.btn2}>Learn More</button></a>
        </div>
      </div>
    </>
  );
